        ...
        const staticProjects = [
            {
                ...
                translations: {
                    es: {
                        title: "Nuestras Casas",
                        content: "Una plataforma inmobiliaria moderna diseñada para mostrar propiedades exclusivas en Arequipa. La interfaz se centra en imágenes de alta calidad y una navegación fluida para mejorar la experiencia del usuario desde el descubrimiento hasta el contacto.",
            ...
            },
            {
                ...
                translations: {
                    es: {
                        title: "Nouveau Wellness Concierge",
                        content: "Un sitio web para un servicio exclusivo de conserjería de bienestar. El diseño irradia calma y exclusividad, utilizando una paleta de colores suave y tipografía elegante que refleja el compromiso de la marca con la atención personalizada.",
            ...
            },
            {
                ...
                translations: {
                    es: {
                        title: "Bijou Me",
                        content: "Un destino de comercio electrónico para joyería exclusiva. El sitio ofrece una experiencia de compra sofisticada con exhibiciones dinámicas de productos y un proceso de pago integrado.",
            ...
            },
            {
                ...
                translations: {
                    es: {
                        title: "Cidasa",
                        content: "Sitio web corporativo para un proveedor líder de soluciones industriales. El enfoque consistió en estructurar información compleja en una presencia digital profesional y accesible.",
            ...
            },
            {
                ...
                translations: {
                    es: {
                        title: "BSSN USA",
                        content: "Una plataforma digital robusta para una red de soluciones y seguridad. Las características clave incluyen portales seguros para clientes y seguimiento de servicios en tiempo real.",
            ...
            },
            {
                ...
                translations: {
                    es: {
                        title: "Virako Travel",
                        content: "Un portal de viajes inmersivo que invita a los usuarios a explorar destinos peruanos. Se utilizaron metodologías de narración visual y contenido multimedia enriquecido para capturar la esencia de la aventura.",
            ...
            },
            {
                ...
                translations: {
                    es: {
                        title: "Brandistry",
                        content: "Sitio web de portafolio para una agencia de branding digital. El sitio en sí es un testimonio de las tendencias web modernas, con tipografía audaz y microanimaciones interactivas.",
                        role: "Diseñador Web",
            ...
            },
            {
                ...
                translations: {
                    es: {
                        title: "Santo Huevo",
                        content: "Plataforma de comercio electrónico para Santo Huevo, una marca de granja avícola. Incluye un sistema de campañas promocionales con códigos QR, integración con WhatsApp y una experiencia completa de pedidos en línea para huevos y productos avícolas premium.",
                        role: "Desarrollador Principal",
            ...
            },
            {
                ...
                translations: {
                    es: {
                        title: "Silhouette Agency OS",
                        content: "Sistema Operativo Cognitivo Autónomo para Agencias Creativas. Una versión de código abierto que muestra una arquitectura avanzada de sistemas.",
            ...
            },
            {
                ...
                translations: {
                    es: {
                        title: "Silhouette Framework v4",
                        content: "Framework empresarial inteligente que cuenta con más de 46 equipos de IA especializados, autooptimización, flujos de trabajo dinámicos y monitoreo inteligente 24/7.",
                        role: "Creador",
            ...
            },
            {
                ...
                translations: {
                    es: {
                        title: "Silhouette Brain",
                        content: "Sistema de memoria cognitiva avanzada (Memoria de 4 Niveles) para Agentes de IA, que utiliza bases de datos de grafos y vectorización para una recuperación profunda del contexto.",
            ...
            },
            {
                ...
                translations: {
                    es: {
                        title: "Contract Generator SaaS",
                        content: "SaaS de generación de contratos impulsado por IA. Automatiza flujos de trabajo de redacción legal complejos utilizando Modelos de Lenguaje Grandes.",
                        role: "Desarrollador Full Stack",
